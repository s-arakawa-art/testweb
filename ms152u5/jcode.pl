...
;#
;# ##### This script is modified from original one. #####
;# May 8th,2016
;#  Modified at Line 690 and 699 to be conformed to Perl 5.22 and
;#  redistributed at https://www.marbacka.net/msearch/ .
;#  "unless defined(%hash)" were replaced with "if (!%hash)".
;#
